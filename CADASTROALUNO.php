...
<form method="get" action="controle/controlecurso.php">
            </nav><label></label>
    <label>FAÇA O SEU CADASTRO</label>
            <input class="form-control" type="text" name="nome" placeholder="Nome do aluno" style="margin-left:24px;color:rgb(0,0,0);width:329px;"><label style="color:rgba(0,0,0,0.9);margin-left:10px;"></label>
             <input class="form-control" type="text" name="codigo" placeholder="codigo do aluno" style="margin-left:24px;color:rgb(0,0,0);width:329px;"><label style="color:rgba(0,0,0,0.9);margin-left:10px;"></label>
                ...
                name="email" placeholder="Email" style="width:330px;margin-left:24px;background-color:rgb(252,252,252);"><label style="margin-left:10px;color:rgb(8,8,8);"></label>            <label
